...
$('#modalAlert').append('<div class="w3-modal-content"><div id="modalAlertp3" class="w3-container w3-red w3-center w3-padding"></div></div>');
$('#modalAlertp3').append('<span onclick="closeModalAlert()" class="w3-closebtn">&times;</span><p id="modalText">FEED ME SOME TEXT</p>');
